...
define( 'ESSENTIALS_THEME_VERSION', '1.2.4' );
...
function essentials_scripts() {
	...
	// Theme Styling
		...
		if ( function_exists( 'get_rocket_cdn_url' ) ){
			...
			// $main_values['velocity'] = get_rocket_cdn_url(get_template_directory_uri() .'/js/build/velocity.min.js');
			// $main_values['oneScroll'] = get_rocket_cdn_url(get_template_directory_uri() .'/js/build/jquery.onepage-scroll.min.js');
		}else{
			...
			// $main_values['velocity'] = get_template_directory_uri() .'/js/build/velocity.min.js' ;
			// $main_values['oneScroll'] = get_template_directory_uri() .'/js/build/jquery.onepage-scroll.min.js' ;
		}
...
function ps_redirect_after_logout(){
         wp_redirect( 'http://localhost/brite/' );
         exit();
}