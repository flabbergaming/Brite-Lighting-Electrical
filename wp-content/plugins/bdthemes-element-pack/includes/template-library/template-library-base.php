...
class ElementPack_Template_Library_Base
{
    ...
    public function createTemplateTables()
    {
        ...
        ;
        if(defined('BDTEP_TEMPLATE_LIBRARY_DB_VER') && BDTEP_TEMPLATE_LIBRARY_DB_VER != get_option('BDTEP_TEMPLATE_LIBRARY_DB_VER',false)){
            ...
            update_option('BDTEP_TEMPLATE_LIBRARY_DB_VER',BDTEP_TEMPLATE_LIBRARY_DB_VER);
        }
    ...
    public function get_transient_key(){
        $var = '';
        if(defined('BDTEP_TEMPLATE_LIBRARY_DB_VER')){
            $var = BDTEP_TEMPLATE_LIBRARY_DB_VER;
        }
